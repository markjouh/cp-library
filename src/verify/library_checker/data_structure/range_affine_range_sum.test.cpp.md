...
data:
  ...
  bundledCode: "#line 1 \"src/verify/library_checker/data_structure/range_affine_range_sum.test.cpp\"\
    ...
    \ auto op, auto t_id, class U, auto mapping, auto comp, auto u_id>\nstruct LazySegtree\
    ...
    \ 5 \"src/verify/library_checker/data_structure/range_affine_range_sum.test.cpp\"\
    ...
    \ n, q;\n  cin >> n >> q;\n  \n  vector<S> init(n);\n  for (int i = 0; i < n;\
    \ i++) {\n    ll a;\n    cin >> a;\n    init[i] = {a, 1};\n  }\n  \n  LazySegtree<S,\
    \ op, t_id, F, mapping, comp, u_id> seg(init);\n  \n  while (q--) {\n    int t;\n\
    \    cin >> t;\n    if (t == 0) {\n      int l, r;\n      ll b, c;\n      cin\
