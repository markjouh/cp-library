...
data:
  ...
  bundledCode: "#line 1 \"src/verify/library_checker/graph/scc.test.cpp\"\n#define\
    ...
    \        for (int v : tg[u]) {\n            if (comp[v] == -1) {\n           \
    \     dfs_build(v);\n            }\n        }\n    }\n};\n#line 5 \"src/verify/library_checker/graph/scc.test.cpp\"\
...
layout: document
redirect_from:
- /verify/src/verify/library_checker/graph/scc.test.cpp
- /verify/src/verify/library_checker/graph/scc.test.cpp.html
