...
data:
  ...
  bundledCode: "#line 1 \"src/verify/library_checker/tree/vertex_add_subtree_sum.test.cpp\"\
    ...
    \ ft[p] += v;\n    }\n  }\n\n  T sum(int r) {\n    T res = 0;\n    for (r++; r\
    \ > 0; r -= r & -r) {\n      res += ft[r];\n    }\n    return res;\n  }\n\n  T\
    \ sum(int l, int r) {\n    return sum(r) - sum(l - 1);\n  }\n};\n#line 5 \"src/verify/library_checker/tree/vertex_add_subtree_sum.test.cpp\"\
    \n\nint main() {\n  int n, q;\n  cin >> n >> q;\n  vector<int> a(n);\n  for (int\
...
layout: document
redirect_from:
- /verify/src/verify/library_checker/tree/vertex_add_subtree_sum.test.cpp
- /verify/src/verify/library_checker/tree/vertex_add_subtree_sum.test.cpp.html
