...
constexpr uint64_t pow94[10] = {1, 94, 8836, 830584, 78074896, 7339040224, 689869781056, 64847759419264, 6095689385410816, 572994802228616704};
...
// Generate code to copy paste into frontend
